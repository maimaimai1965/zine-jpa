...
insert into aa_user (user_id,profile_id,uname, user_type, password,state, auth_type,short_name, full_name, created_dt,updated_dt,last_pswd_dt,expiration_dt,locked_dt,login_attemp, sms_no, email, note) values (7,1,'es_aplilayer','E','c4ca4238a0b923820dcc509a6f75849b','E','I','API-LAYER','History Transactions Service API User',current_timestamp,null,current_timestamp,null,null,0,null, null, null);
